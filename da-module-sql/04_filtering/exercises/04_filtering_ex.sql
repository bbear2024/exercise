...
SELECT name,
	   ...
	   country
FROM airports
WHERE country = 'Belgium' OR country = 'Netherlands' OR country = 'Luxembourg';
...
SELECT name,
	   ...
	   alt
FROM airports
WHERE NOT (country = 'Belgium' OR country = 'Netherlands' OR country = 'Luxembourg')
	  AND alt < 0;
...
SELECT *
FROM flights
WHERE flight_date = '2023-12-31' AND (dep_time IS NULL OR cancelled = 1)
